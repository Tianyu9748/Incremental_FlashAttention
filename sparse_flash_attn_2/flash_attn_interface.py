...
@_torch_custom_op_wrapper("sparse_flash_attn_2::_flash_attn_forward", mutates_args=(), device_types="cuda")
def _flash_attn_forward(
    ...
    out, softmax_lse, S_dmask, rng_state = flash_attn_gpu.fwd(
        ...
        return_softmax,
        None,
        None,  # sparse_block_table (plan.md) — not exposed via the dense path
    )
    return out, softmax_lse, S_dmask, rng_state


@_torch_register_fake_wrapper("sparse_flash_attn_2::_flash_attn_forward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_forward = torch.ops.sparse_flash_attn_2._flash_attn_forward
else:
    _wrapped_flash_attn_forward = _flash_attn_forward


@_torch_custom_op_wrapper("sparse_flash_attn_2::_flash_attn_varlen_forward", mutates_args=(), device_types="cuda")
...
@_torch_register_fake_wrapper("sparse_flash_attn_2::_flash_attn_varlen_forward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_varlen_forward = torch.ops.sparse_flash_attn_2._flash_attn_varlen_forward
else:
    _wrapped_flash_attn_varlen_forward = _flash_attn_varlen_forward


@_torch_custom_op_wrapper("sparse_flash_attn_2::_flash_attn_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("sparse_flash_attn_2::_flash_attn_backward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_backward = torch.ops.sparse_flash_attn_2._flash_attn_backward
else:
    _wrapped_flash_attn_backward = _flash_attn_backward


@_torch_custom_op_wrapper("sparse_flash_attn_2::_flash_attn_varlen_backward", mutates_args=("dq", "dk", "dv"), device_types="cuda")
...
@_torch_register_fake_wrapper("sparse_flash_attn_2::_flash_attn_varlen_backward")
...
if torch.__version__ >= "2.4.0":
    _wrapped_flash_attn_varlen_backward = torch.ops.sparse_flash_attn_2._flash_attn_varlen_backward
else:
