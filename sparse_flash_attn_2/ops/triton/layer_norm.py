...
from sparse_flash_attn_2.utils.torch import custom_fwd, custom_bwd
from sparse_flash_attn_2.utils.library import triton_op
...
@triton_op("sparse_flash_attn_2::layer_norm_fwd_impl", mutates_args={"out", "residual_out"},
...
@triton_op("sparse_flash_attn_2::layer_norm_bwd_impl", mutates_args={},
