...
from sparse_flash_attn_2.utils.distributed import get_dim_for_local_rank

try:
    from sparse_flash_attn_2 import (
...
try:
    from sparse_flash_attn_2.ops.fused_dense import ColumnParallelLinear, RowParallelLinear
except ImportError:
    ColumnParallelLinear, RowParallelLinear = None, None

try:
    from sparse_flash_attn_2.layers.rotary import RotaryEmbedding
except ImportError:
